inherited frmCadContasReceber: TfrmCadContasReceber
  ...
  Caption = 'Lan'#231'amento - Contas a Receber (Conta)'
  ClientHeight = 290
  ClientWidth = 392
  ...
  object gpbDataVencimento: TGroupBox
    ...
    TabOrder = 1
    object dbeDataRecebimento: TDBEdit
      Left = 8
      Top = 15
      Width = 125
      Height = 21
      DataField = 'DT_RECEBIMENTO'
      DataSource = dtsContasReceber
      TabOrder = 0
    end
  end
  ...
  object gpbPagarA: TGroupBox
    ...
    Caption = 'Receber de'
    TabOrder = 3
    object dbeReceberDe: TDBEdit
      Left = 8
      Top = 15
      Width = 360
      Height = 21
      DataField = 'DS_RECEBERDE'
      DataSource = dtsContasReceber
      TabOrder = 0
    end
  end
  ...
  object CamposObrigatorios: TValueListEditor
    ...
    Strings.Strings = (
        ...
        'dbeDataRecebimento=O campo Data de Recebimento deve ser informad' +
        'o'
  ...
  object dtsContasReceber: TDataSource
    DataSet = frmLctContasReceber.qryCadPadrao
    Left = 323
    Top = 58
  end
end
