inherited frmSelProdutoCodigo: TfrmSelProdutoCodigo
  ...
  object gpbCodigoFabricante: TGroupBox
    Left = 20
    Top = 16
    Width = 420
    Height = 53
  ...
  object qryConsProduto: TIBOQuery
    ...
    SQL.Strings = (
      ...
      '       CAD_FORNECEDOR.DS_NOME AS DS_NOMEFORNECEDOR'
      'FROM CAD_PRODUTO'
      
        'LEFT JOIN CAD_FORNECEDOR ON(CAD_FORNECEDOR.CD_FORNECEDOR = CAD_P' +
        'RODUTO.CD_FORNECEDOR)'
      'WHERE UPPER(CAD_PRODUTO.CD_FABRICANTE) = UPPER(:CD_FABRICANTE)')
    Left = 352
    Top = 24
  end
end
