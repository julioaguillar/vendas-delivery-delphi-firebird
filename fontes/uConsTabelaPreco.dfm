inherited frmConsTabelaPreco: TfrmConsTabelaPreco
  BorderIcons = [biSystemMenu]
  Caption = 'Consulta - Tabela de Pre'#231'o dos Produtos/Mercadorias'
  ClientHeight = 572
  ClientWidth = 876
  ...
  object gpbDetalhamento: TGroupBox
    ...
    object dbtUnitario: TDBText
      Left = 696
      Top = 22
      Width = 160
      Height = 35
      Alignment = taCenter
      DataField = 'P_OU_VR_PRECOVENDA'
      DataSource = dtsConsulta
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -27
