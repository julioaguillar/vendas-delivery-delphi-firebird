inherited frmConsVendedorVenda: TfrmConsVendedorVenda
  ...
  object gpbPesquisa: TGroupBox
    ...
    object edtPesquisa: TEdit
      ...
      ParentFont = False
      TabOrder = 0
      TextHint = 'Digite o nome para pesquisa'
  ...
  object dtsRegistros: TDataSource
    DataSet = qryConsVendedor
    Left = 96
    Top = 312
  end
  object qryConsVendedor: TIBOQuery
    ...
    SQL.Strings = (
      ...
      'WHERE UPPER( CAD_PROFISSIONAL.DS_NOME ) LIKE UPPER( '#39'%%'#39' )'
