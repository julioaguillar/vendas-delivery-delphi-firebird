inherited frmConfigurarServidor: TfrmConfigurarServidor
  ...
  object gpbEstacaoServidora: TGroupBox
    Left = 114
    Top = 8
    Width = 277
    Height = 45
    Caption = 'Nome Esta'#231#227'o Servidora'
  ...
  object gpbCaminho: TGroupBox
    ...
    object cbbCaminho: TComboBox
      ...
      ParentFont = False
      TabOrder = 0
      OnEnter = cbbCaminhoEnter
    end
  end
  object gpbServidor: TGroupBox
    Left = 8
    Top = 8
    Width = 102
    Height = 45
  ...
  object qryUsuarioOnline: TIBOQuery
    Params = <
      item
        DataType = ftUnknown
        Name = 'DS_USUARIO'
    ...
    IB_Transaction = trnsUsuario
    PreparedEdits = True
    PreparedInserts = True
    RecordCountAccurate = True
    SQL.Strings = (
      'UPDATE CAD_USUARIO'
      'SET FG_USUARIOONLINE = '#39'N'#39
      'WHERE DS_USUARIO = :DS_USUARIO')
    Left = 61
    Top = 112
  end
  object trnsUsuario: TIB_Transaction
    IB_Connection = dmPrincipal.IB_Connection
