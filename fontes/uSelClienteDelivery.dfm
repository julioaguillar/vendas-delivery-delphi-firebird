inherited frmSelClienteDelivery: TfrmSelClienteDelivery
  BorderIcons = [biSystemMenu]
  Caption = 'Seleciona - CLiente Delivery'
  ClientHeight = 243
  ClientWidth = 981
  ...
  object gpbRegistros: TGroupBox
    ...
    object dbgRegistros: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'NR_TELRESIDENFORMATADO'
  ...
  object dtsConsCliente: TDataSource
    DataSet = frmLctVendaDelivery.qryConsCliente
    Left = 56
    Top = 136
  end
end
