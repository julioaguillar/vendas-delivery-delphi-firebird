inherited frmSelProdutoCodigoVarios: TfrmSelProdutoCodigoVarios
  BorderIcons = [biSystemMenu]
  Caption = 'Seleciona - Produto/Mercadoria'
  ClientHeight = 250
  ClientWidth = 994
  ...
  object dtsConsProduto: TDataSource
    DataSet = frmSelProdutoCodigo.qryConsProduto
    Left = 88
    Top = 104
  end
end
