inherited frmCadAgendaTelefone: TfrmCadAgendaTelefone
  BorderIcons = [biSystemMenu]
  Caption = 'Cadastro - Agenda Telefonica'
  ClientHeight = 307
  ClientWidth = 438
  ...
  object gpbContato: TGroupBox
    ...
    object dbeContato: TDBEdit
      ...
      DataSource = dtsAgendaTelefone
      TabOrder = 0
    end
  end
  object gpbResidencial: TGroupBox
    Left = 8
    Top = 58
    Width = 137
    Height = 44
  ...
  object CamposObrigatorios: TValueListEditor
    ...
    ScrollBars = ssNone
    Strings.Strings = (
      'dbeContato=O campo Contato deve ser informado')
    TabOrder = 7
  ...
  object dtsAgendaTelefone: TDataSource
    DataSet = frmAgendaTelefone.qryAgendaTelefone
    Left = 251
    Top = 214
  end
end
